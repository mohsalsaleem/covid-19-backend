...
public class UserService {
    ...
    public User registerUser(UserDTO userDTO, String password, String userType) {
        ...
        // Generate based on user type requested
        authorityRepository.findById(userType.toString()).ifPresent(authorities::add);
    ...
    public List<UserDTO> search(String query) {
        return userRepository
            .findTop50ByFirstNameIgnoreCaseContainingOrLastNameIgnoreCaseContaining(query, query)
            .stream()
            .map(UserDTO::new)
